...
\institute{C. Brown, V. Janjic \at
	...
	\and
	Kamran Idrees, Colin Glass, Mhd. Amer Wafai \at
    High Performance Computing Centre Stuttgart (HLRS) \\ Stuttgart, Germany \\
   \email{\{idrees, glass, wafai\}@hlrs.de}
}
...
skeleton configuration, $\Delta(r) \parallel \Delta(p)$, the refactoring tool may produce the following:
  \begin{lstlisting}[language=C]
  ff_farm<> readFarm;
  ...
...
architecture, or if after executing the program, the programmer discovers that an alternative configuration given at Step 5 would be better suited.
\end{enumerate}
%\noindent
...
\newblock {\em Submitted to PDP} 2014.
...
\newblock {\em Proc. of IEEE Congress on Evol. Comp.} Cancun, Mexico. May. 2013. 
